              ...
              {navItems.map((item) =>
                item.type === "route" ? (
                  <li key={item.name}>
                    <Link
                      to={item.path}
                      className="text-[#1E1E1E] hover:text-van-teal transition-all duration-300"
                    >
                      {item.name}
                    </Link>
                  </li>
                ...
                item.type === "route" ? (
                  ...
                  <li key={item.name}>
                    <button
                      ...
                      className="w-full text-left text-[#1E1E1E] hover:text-van-teal transition-all duration-300"
                    >
                      {item.name}
                    </button>
                  </li>
