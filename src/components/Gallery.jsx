      ...
      <div className="flex flex-wrap justify-center gap-4 mb-10">
        {categories.map((cat) => (
          <button
            ...
            className={`btn ${
              active === cat
                ? "bg-van-teal text-white border-none"
                : "bg-gray-200 text-gray-700 hover:bg-van-teal-light hover:text-white"
            }`}
          >
            {cat}
          </button>
        ...
        <div>
          ...
          <div className="text-center mt-6">
            <button
              ...
              className="btn bg-van-teal text-white hover:bg-van-teal-dark"
            >
              Back to Gallery
            </button>
          </div>
